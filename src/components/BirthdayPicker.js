...
export default class BirthdayPicker extends React.Component {
    ...
    getMonthNames() {
        ...
        // var monthNames = [];
        // for (var i = 0; i < 12; i++) {
        //     var date = new Date(this.state.year, i, 1);
    ...
    render() {
        return (
            <View style={styles.container}>
                <Picker itemStyle={{ height: 50 }} style={styles.dayPicker} selectedValue={this.state.day} onValueChange={this.onDayChange}>
                    {this.renderDayPickerItems()}
                </Picker>

                <Picker itemStyle={{ height: 50 }} style={styles.monthPicker} selectedValue={this.state.month} onValueChange={this.onMonthChange}>
                    {this.renderMonthPickerItems()}
                </Picker>



                <Picker itemStyle={{ height: 50 }} style={styles.yearPicker} selectedValue={this.state.year} onValueChange={this.onYearChange}>
