              ...
              {occupation === "Tutoring" ? (
                <>
                  ...
                  >
                    ...
                    <Picker.Item
                      label="elementary tutors"
                      value="elementary tutors"
                    />
                    <Picker.Item
                      label="subject tutors"
                      value="subject tutors"
                    />
                    <Picker.Item
                      label="general tutors"
                      value="general tutors"
                    />
                    <Picker.Item
                      label="homework helpers"
                      value="homework helpers"
                    />
                  </Picker>
                </>
              ) : (
